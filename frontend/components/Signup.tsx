    ...
    return (
        <div className="w-full h-screen flex justify-center items-center">
            <div className="shadow-lg rounded-lg w-[30%] h-[70%] flex flex-col justify-center p-6 gap-y-4">
                <Heading />
                <SubHeading />
                <InputBox label="Username" placeholder="Enter your username" onChange={(e) => setUsername(e.target.value)} value={username}/>
...
function SubHeading() {
    return (
        <p className="text-center my-1 text-lg text-gray-500">Already have an account? <Link className="underline" to="/login">Login</Link></p>
    )
}
